...
public sealed class DatabaseInitializer_SqlServer(
    ...
    ILogger<DatabaseInitializer_SqlServer> _logger) : IDatabaseInitializer
{
    ...
    private async Task seedInitialData()
    {
        ...
        // bulkCopy.ColumnMappings.Add(nameof(OutboxMessage.Id),         nameof(OutboxMessage.Id)); // Generated by SQL Server
    ...
    private static DataTable get_OutboxMessage_DataTable(int batchSize, int totalRecords)
    {
        ...
        {
            dataTable.Rows.Add(OrderCreatedEvent.FullName, eventJson, DateTime.UtcNow);
        }
